import{D as n,r as s,a as m,t as p,d as u}from"./Data-CxdGCdzi.js";import{F as g}from"./Favorites-BOcg7ug3.js";function w(t){const e=t.date,a=new Date(e),r=String(a.getUTCDate()).padStart(2,"0"),o=String(a.getUTCMonth()+1).padStart(2,"0"),l=a.getUTCFullYear(),c=String(a.getUTCHours()).padStart(2,"0"),d=String(a.getUTCMinutes()).padStart(2,"0");return`
    <div class="news-card">
