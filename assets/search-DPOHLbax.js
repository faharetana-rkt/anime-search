import{D as i,r as o,a as l,t as d,d as c}from"./Data-BJxmCOTU.js";import{F as m}from"./Favorites-CpL2ishm.js";function u(e){return`
    ...
    `}class p{constructor(t,a){this.parentElement=t,this.input=a}async init(){this.input.toLowerCase();const a=`https://api.jikan.moe/v4/anime?q=${encodeURI(this.input)}&limit=25&sfw=true`,s=await new i(a).getData();this.renderAnimes(s.data)}renderAnimes(t){if(t.length===0){this.parentElement.innerHTML='<p class="not-found">No anime with that name could be found.</p>';return}o(this.parentElement,u,t)}}l(document.querySelector("#currentYear"));d(document.querySelector("#menu"),document.querySelector("#animateme"));c(document.querySelectorAll(".link"));const n=document.querySelector(".search-input"),r=document.querySelector(".searched-anime"),h=new m("animes");n.addEventListener("keydown",e=>{e.key==="Enter"&&new p(r,n.value).init()});r.addEventListener("click",e=>{const a=e.target.closest(".add-to-favorite").dataset.id;h.addToFavorites(a)});
